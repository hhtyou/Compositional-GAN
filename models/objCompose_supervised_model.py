...
class objComposeSuperviseModel(BaseModel):
    ...
    def set_input_landmark(self, input):


        self.landmark = input['landmark']
        self.mark_paths = input['mark_paths']
        ...
        self.landmark = Variable(self.landmark)
        #print("self.landmark",self.landmark)
    ...
    def set_input(self, input):
        ...
        if len(self.gpu_ids) > 0:
            ...
            #self.landmark = self.landmark.cuda(self.gpu_ids[0], async=True)
    ...
    def forward(self):
        ...
        print("fake_A",self.fake_A.shape)
        print("fake_A1_T",self.fake_A1_T.shape)
        print("fake_A2_T",self.fake_A2_T.shape)
...
class objComposeSuperviseModelland(BaseModel):
    def name(self):
        return 'objComposeSuperviseModelland'
